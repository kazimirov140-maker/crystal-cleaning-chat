...
Вставляй этот блок <LEAD_DATA> в каждое свое сообщение ПОСЛЕ того, как узнала телефон клиента, обновляя данные внутри него по мере поступления новой информации.
ПОСЛЕ блока <LEAD_DATA> напиши свой обычный текстовый ответ клиенту. Никогда не упоминай клиенту о существовании этого блока данных.`;
